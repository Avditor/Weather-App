...
export default function InfoBox({info}) {
  ...
  const INIT_URL = "https://images.unsplash.com/photo-1615827648210-b5570ec8652a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
    ...
    <div className='cardContainer'>
      ...
      <CardContent>
        ...
        <Typography variant="body2" sx={{ color: 'text.secondary' }} component={"span"}>
          ...
          <p>The weather is having <i>{info.weather}</i> and feels like {info.feelsLike}&deg;C</p>
        </Typography>
      </CardContent>
